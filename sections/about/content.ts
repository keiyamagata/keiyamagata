export const skills = [
  ...
  },
  {
    ...
    text: "React, Next.js, Vue.js, Nuxt, React Query, React Hook Form, Tailwind CSS, GSAP, Framer Motion, Material UI, Zustand, Pinia, Three.js, Pusher",
  },
  {
    title: "Tools & Platforms",
    text: "MongoDB, Prisma, Git, GitHub, Figma, Storyblok, Contentful, Supabase, Vercel, Netlify",
  },
  {
    title: "Testing",
    text: "Cypress, Jest",
